		...
		template:`
			...
			<div class='calendar'>
			  <div class='calendar_left'>
			    <div class='header'>
			      <i class='material-icons' ng-click='$ctrl.prev()'>navigate_before</i>
			      <h1>{{$ctrl.month}}</h1>
			      <i class='material-icons' ng-click='$ctrl.next()'>navigate_next</i>
			    </div>
			    <div class='days'>
			  ...
			  <div class='calendar_right'>
			    <div class='list'>
			      <ul>
			        <li class='bounce-in' ng-repeat='events in $ctrl.events' ng-show='events.id === $ctrl.dataId'>
			          <span class='type'>It is a {{ events.type }} thing</span>
			          <span class='description'>{{ events.description }}</span>
			        </li>
			      </ul>
			    </div>
			    <form ng-submit='$ctrl.add()'>
			      <input ng-model='$ctrl.description' placeholder='Enter a task for this day' type='text'>
			        <select ng-model='$ctrl.type' placeholder='$ctrl.type'>
